   ...
   return (
      <div className='w-[350px] p-4 bg-white rounded-xl' >
         <figure className='mb-2'>
            <img className='w-full h-[170px]' src={coverImage} alt={courseName} />
         </figure>
         <h3 className='text-xl font-semibold text-[#1C1B1B] mb-3'>{courseName}</h3>
         <p className='text-sm text-[rgba(28,27,27,0.6)] leading-6 mb-4'>{description}</p>

         <div className='flex justify-between items-center mb-6'>
            <div className='flex items-center gap-3'>
               <img src={dollerSign} alt="" />
               <p className='text-[rgba(28,27,27,0.5)] text-lg font-semibold'>Price : {coursePrice}</p>
            </div>
            <div className='flex items-center gap-3'>
